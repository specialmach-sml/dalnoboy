...
app.get("/orders", async (req, res) => {
  return res.status(403).json({
    success: false,
    error: "legacy_orders_endpoint_disabled"
  });
});
...
app.post("/api/location", async (req, res) => {
  return res.status(403).json({
    success: false,
    error: "legacy_location_endpoint_disabled"
  });
});
...
app.post("/api/respond", async (req, res) => {
  return res.status(403).json({
    success: false,
    error: "public_respond_endpoint_disabled"
  });
});
...
app.post("/api/cargo/offer", async (req, res) => {
  return res.status(403).json({
    success: false,
    error: "public_cargo_offer_endpoint_disabled"
  });
});
